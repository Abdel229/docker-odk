...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('admin_settings', function (Blueprint $table) {
            ...
            $table->integer('min_number_followers')->default(0);
            ...
            $table->text('earnings_simulator_head')->nullable();
            $table->text('earnings_simulator_subtitle')->nullable();
            $table->unsignedInteger('monthly_subscription_price');
            ...
            $table->string('agora_certificat')->nullable();
            ...
            $table->integer('max_number_followers')->default(0);
            ...
            $table->boolean('product_content')->nullable();
