...
Route::get("lang/change", [LangController::class, "change"])->name("lang.change");//Change lang route
...
Route::group(['middleware' => 'auth'], function () {
    ...
    // Payout Method
    Route::get('settings/payout/method', 'UserController@payoutMethod')->name("payout.method");
    Route::post('settings/payout/method/{type}', 'UserController@payoutMethodConfigure')->name("payout.method-type");
    ...
    // My Wallet
    Route::get('my/wallet', 'AddFundsController@wallet')->name("add-funds.wallet");
    Route::get('deposits/invoice/{id}', 'UserController@invoiceDeposits')->name("deposits.invoice");
    ...
    // Pay Per Views
    Route::post('send/ppv', 'PayPerViewController@send')->name("send.ppv");
...
Route::group(['middleware' => 'role'], function () {
    ...
    Route::get('panel/admin/settings/front_setting', 'AdminController@settingsfront');
	Route::post('panel/admin/settings/saveFrontSettings', 'AdminController@saveFrontSettings');
    ...
    Route::get('panel/admin/productcategories/edit/{id}', 'AdminController@editproductCategories')->name('categories');
    Route::post('panel/admin/productcategories/update', 'AdminController@updateproductCategories');
    Route::post('panel/admin/productcategories/delete/{id}', 'AdminController@deleteproductCategories');
...
Route::get('add/custom/product/content', 'ProductsController@createCustomProductContent')->middleware('auth');
Route::post('add/custom/product/content', 'ProductsController@storeCustomProductContent')->middleware('auth');


Route::post('edit/product/{id}', 'ProductsController@update')->middleware('auth');
Route::post('edits/product/{id}', 'ProductsController@updates')->middleware('auth');
