...
@section('title') {{ \Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.creators_live'), config("app.locale")) }} -@endsection
        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-12 py-5">
                    <h2 class="mb-0 text-break">{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.creators_live'), config("app.locale")) }}</h2>
            ...
            @endif
              ...
              <span class="btn-block mb-3">
                <i class="bi bi-broadcast ico-no-result"></i>
                            ...
                            <h4 class="font-weight-light">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.no_live_streams'), config("app.locale"))}}</h4>
                        </div>
                    </div>
                @endif
            </div>
