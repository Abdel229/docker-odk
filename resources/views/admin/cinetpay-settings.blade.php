           ...
           <!-- Start Box Body -->
            <div class="box-body">
              ...
              <!-- Start Box Body -->
               <div class="box-body">
                 <div class="form-group">
                   <label class="col-sm-2 control-label">{{ trans('admin.cinetpay_account') }}</label>
                   <div class="col-sm-10">
                     <input type="text" value="{{ $data->email }}" name="email" class="form-control" placeholder="{{ trans('admin.cinetpay_account') }}">
                   </div>
                 </div>
               </div><!-- /.box-body -->
               ...
               <div class="box-body">
                 <div class="form-group">
                   <label class="col-sm-2 control-label">Cinetpay Sandbox</label>
                   <div class="col-sm-10">
                     <div class="radio">
                     <label class="padding-zero">
