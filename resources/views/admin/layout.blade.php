        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview @if( Request::is('panel/admin/settings') || Request::is('panel/admin/settings/limits') ) active @endif">
            ...
            <ul class="treeview-menu">
              ...
              <li @if(Request::is('panel/admin/settings/limits')) class="active" @endif><a href="{{ url('panel/admin/settings/front_setting') }}"><i class="fas fa fa-angle-right"></i> Front Setting</a></li>
            </ul>
          </li><!-- ./Links -->
          @endif
        ...
        <section class="sidebar">
          ...
          @if (auth()->user()->hasPermission('products'))
            ...
            <li @if(Request::is('panel/admin/products')) class="active" @endif>
             ...
             <!-- Links -->
             <li @if(Request::is('panel/admin/productcategories')) class="active" @endif>
            	<a href="{{ url('panel/admin/productcategories') }}"><i class="fa fa-tag"></i> <span>{{ trans('products  categories') }}</span></a>
            </li><!-- ./Links -->
          @endif
