              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="fee_commission" class="form-control">
                    @for ($i=0; $i <= 50; ++$i) <option @if ($settings->fee_commission == $i) selected="selected" @endif value="{{$i}}">{{$i}}%</option>
                      @endfor
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="percentage_referred" class="form-control">
                    @for ($i=2; $i <= 10; ++$i) <option @if ($settings->percentage_referred == $i) selected="selected" @endif value="{{$i}}">{{$i}}%</option>
                      @endfor
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="referral_transaction_limit" class="form-control">
                    ...
                    @for ($i=1; $i <= 100; ++$i) <option @if ($settings->referral_transaction_limit == $i) selected="selected" @endif value="{{$i}}">{{$i}}</option>
                      @endfor
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="days_process_withdrawals" class="form-control">
                    @for ($i=1; $i <= 30; ++$i) <option @if( $settings->days_process_withdrawals == $i ) selected="selected" @endif value="{{$i}}">{{$i}} ({{trans_choice('general.days', $i)}})</option>
                      @endfor
                  </select>
                </div>
              </div>
