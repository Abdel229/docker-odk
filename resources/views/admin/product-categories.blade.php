      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h4>
           ...
           <a href="{{ url('panel/admin/productcategories/add') }}" class="btn btn-sm btn-success no-shadow">
               ...
               <tbody>
                  ...
                  @foreach( $categories as $category )
                    <tr>
                      ...
                      <td>{{ $category->name }}</td>
                      <td>
                      	<a href="{{ url('panel/admin/productcategories/edit/').'/'.$category->id }}" class="btn btn-success btn-sm padding-btn">
                      		{{ trans('admin.edit') }}
                      	</a>

                        {!! Form::open([
                          'method' => 'POST',
                          'url' => "panel/admin/productcategories/delete/$category->id",
                          'class' => 'displayInline'
                        ]) !!}
