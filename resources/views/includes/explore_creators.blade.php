<div class="mb-2">
    <h6 class="mb-3 text-muted font-weight-light">
        {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.explore_creators'), config("app.locale"))}}
        ...
        @else
            <a href="{{url('creators')}}" class="float-right">{{ __('general.view_all') }} <small class="pl-1"><i
                        class="fa fa-long-arrow-alt-right"></i></small></a>
        @endauth
    </h6>
