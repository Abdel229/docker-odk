...
<!-- App css -->
<link href="{{ asset('admin/css/app.css')}}?v={{$settings->version}}" rel="stylesheet" type="text/css" />

 <!-- Theme style -->
<link href="{{ asset('admin/css/AdminLTE.min.css')}}?v={{$settings->version}}" rel="stylesheet" type="text/css" />
>>>>>>> main
