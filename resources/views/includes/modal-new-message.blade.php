            ...
            <div class="modal-body p-0">
                <div class="card bg-white shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <div class="mb-2">
                            <h5 class="position-relative m-0">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.new_message'), config("app.locale"))}}
                            ...
                            @if (auth()->user()->verified_id == 'yes' && request()->is('messages') && auth()->user()->totalSubscriptionsActive() > 1)
                                <span class="form-text">
									<a href="javascript:void(0);" data-toggle="modal" data-target="#newMessageMassive"
                                       data-dismiss="modal" class="btn btn-primary btn-sm w-100 mt-2">
										<i class="feather icon-users"></i> {{ \Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.to_all_my_subscribers'), config("app.locale")) }}
									</a>
								</span>
                            @endif
                        ...
                        <div class="position-relative">
                            ...
                            <input class="form-control input-new-msg rounded mb-2" id="searchCreator" type="text"
                                   name="q" autocomplete="off"
                                   placeholder="{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans(auth()->user()->verified_id == 'yes' ? trans('general.search') : trans('general.find_user'), config("app.locale")) }}"
                                   aria-label="Search">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-bottom-0">
                <h5 class="modal-title">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.new_message_all_subscribers'), config("app.locale"))}}</h5>
            ...
            <div class="modal-body">
                <form method="POST" action="{{url('new/message/massive')}}" enctype="multipart/form-data"
                      id="formSendMsg">
                            ...
                            <div class="media">
                                <div class="media-body">
                                    <textarea rows="5" cols="40"
                                              ...
                                              class="form-control textareaAutoSize border-0" id="message"
                        ...
                        <div class="card-footer bg-white border-0 pt-0 position-relative">
                            ...
                            <div class="form-group display-none mt-2" id="price">
                                <div class="input-group mb-2">
                                    ...
                                    <input class="form-control isNumber" value="" autocomplete="off" name="price"
                            ...
                            <div class="justify-content-between align-items-center">
                                ...
                                <button type="button"
                                        class="btn btn-upload btn-tooltip p-bottom-8 e-none align-bottom @if (auth()->user()->dark_mode == 'off') text-primary @else text-white @endif rounded-pill"
                                        data-toggle="tooltip" data-placement="top"
                                ...
                                <button type="button" id="setPrice"
                                        ...
                                        data-toggle="tooltip" data-placement="top"
                                        title="{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('general.set_price_for_msg'), config("app.locale"))}}">
                                    <i class="feather icon-tag f-size-25"></i>\Stichoza\GoogleTranslate\GoogleTranslate::trans
                                </button>

                                <div class="d-inline-block float-right mt-3 rounded-pill position-relative">
                                    <div class="btn-blocked display-none"></div>
                                    <button disabled type="submit" id="button-reply-msg"
                                            class="btn btn-sm btn-primary rounded-pill float-right e-none"><i
