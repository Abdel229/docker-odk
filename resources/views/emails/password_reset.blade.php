            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td style="padding: 25px 0; text-align: center;">
                        <a style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #2F3133; text-decoration: none; text-shadow: 0 1px 0 white;"
                           href="http://localhost/gostock" target="_blank">
                            {{$settings->title}}
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0;" align="center"
                            ...
                            <tr>
                                <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px;">
                                    <!-- Greeting -->
                                    <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                                        {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('emails.hello'), config("app.locale"))}}
                                    </h1>

                                    <!-- Intro -->
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('emails.password_reset_msg'), config("app.locale"))}}
                                    </p>
                 ...
                 text-align: center; text-decoration: none; -webkit-text-size-adjust: none; background-color: #3869D4;"
                                                   class="button"
                                                   target="_blank">
                                                    {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('emails.password_reset'), config("app.locale"))}}
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <!-- Outro -->
                                    <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                        {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('emails.password_reset_msg_2'), config("app.locale"))}}
                                    </p>
                                    ...
                                    <table style="margin-top: 25px; padding-top: 25px; border-top: 1px solid #EDEFF2;">
                                        <tr>
                                            <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                    {{\Stichoza\GoogleTranslate\GoogleTranslate::trans(trans('emails.password_reset_msg_3'), config("app.locale"))}}
                                                </p>

                                                <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                                    <a style="color: #3869D4;" href="{{url('password/reset', $token)}}"
                                                       target="_blank">
                                                        {{url('password/reset', $token)}}
                                                    </a>
                                                </p>
                        ...
                        <table style="width: auto; max-width: 570px; margin: 0 auto; padding: 0; text-align: center;"
                            ...
                            <tr>
                                <td style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #AEAEAE; padding: 35px; text-align: center;">
                                    <p style="margin-top: 0; color: #74787E; font-size: 12px; line-height: 1.5em;">
                                        &copy; <?php echo date('Y'); ?>
                                        <a style="color: #3869D4;" href="{{url('/')}}"
                                           target="_blank">{{$settings->title}}</a>.
