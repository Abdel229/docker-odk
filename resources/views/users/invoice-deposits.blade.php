    ...
    <section class="invoice">
            ...
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    <small
                        ...
                        : {{Helper::formatDate($data->date)}}</small>
                </h2>
            </div>
            <!-- /.col -->
        </div>
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <b>{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(__('general.payment_due'), config('app.locale'))}}</b> {{Helper::formatDate($data->date)}}
                <br>
            </div>
            <!-- /.col -->
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>1</td>
                        <td>{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(__('general.add_funds'), config('app.locale'))}}</td>
                        <td>{{Helper::amountFormatDecimal($amount)}} {{ $settings->currency_code }}</td>
                    </tr>
                    </tbody>
                </table>
            ...
            <div class="col-xs-6">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th class="w-50">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans(__('general.transaction_fee'), config('app.locale'))}}
                                : {{ $percentageApplied }}</th>
                            <td>{{Helper::amountFormatDecimal($transactionFee)}} {{ $settings->currency_code }}</td>
                        </tr>
                        ...
                        <tr class="h4">
                            ...
                            <td>
                                <strong>{{Helper::amountFormatDecimal($totalAmount)}} {{ $settings->currency_code }}</strong>
                            </td>
                        </tr>
                    </table>
                </div>
