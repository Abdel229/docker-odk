                        ...
                        <form method="post" action="{{url('buy/now/product')}}" id="shopProductForm">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div class="form-group mb-2">
                                    <textarea class="form-control textareaAutoSize" name="description_custom_content"
                                              id="descriptionCustomContent"
                                              placeholder="{{ \Stichoza\GoogleTranslate\GoogleTranslate::trans(__('general.description_product_content'), config("app.locale")) }}"
                                              rows="4"></textarea>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <small class="subtotal font-weight-bold">
                                                    {{Helper::amountFormatDecimal($product->product_promo!=0?$product->price-($product->price*$product->product_promo/100):$product->price)}}
                                                </small>
                                            </div>
                                        </div>
                                    </li>
